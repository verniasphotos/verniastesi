...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../passive_ris.png}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../active_ris.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{Images/UAV1_UAV2.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{../Test_2_B_Successo_RIS.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \caption{Andamento temporale RMSE}
